...
The `slim-staging` maintainers take all security issues in the project
seriously. Thank you for improving the security of `slim-staging`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`slim-staging` leverages GitHub's private vulnerability reporting.
